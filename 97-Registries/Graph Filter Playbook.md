...
```text
-path:92-Prompts -path:93-Templates -path:94-Bases -path:95-Canvas -path:91-Agent-Instructions
```

## Filtro Tecnico

```text
path:04-Engineering OR path:05-Production OR path:06-Security OR path:07-Agents-AI OR path:08-Memory-Embeddings OR path:09-Pipeline OR path:10-Monorepo OR path:11-GCP-Infra
```
