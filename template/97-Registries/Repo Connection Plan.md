...
|---|---|---|
| Monorepo {{STARTUP_NAME}} | Evidence Registry + notas verificadas | evita submodulos y ruido |
| Pipeline | Evidence Registry + notas verificadas | mantiene independencia |
| {{CLOUD_PROVIDER}} | Production Status + evidencia manual/automatizable | runtime no vive en Obsidian |
